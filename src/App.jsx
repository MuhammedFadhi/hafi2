...
const ArchOrnament = () => (
  <svg width="100" height="38" viewBox="0 0 100 38" fill="none" aria-hidden="true">
    <path d="M2 30c14 0 20-24 48-24s34 24 48 24" stroke="var(--silver)" strokeWidth="1.2" />
    <circle cx="50" cy="6" r="3" fill="var(--silver)" />
  </svg>
);
...
function App() {
  ...
  // Ambient sparkle field behind the card
          ...
          <div className={`env-flap ${isEnvelopeOpen ? 'env-flap--open' : ''}`}>
            <div className="env-flap-front">
              <svg className="env-flap-crease" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true">
                <path d="M0 0 L50 100 L100 0" fill="none" stroke="#5f7568" strokeWidth="0.5" opacity="0.4" />
                <path d="M0.6 0.6 L50 98.7 L99.4 0.6" fill="none" stroke="#eef4f0" strokeWidth="0.4" opacity="0.5" />
              </svg>
            </div>
            ...
            <svg width="132" height="132" viewBox="0 0 180 180" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <radialGradient id="wg" cx="35%" cy="28%" r="72%">
                  ...
                  <stop offset="40%" stopColor="#eef4f0" />
                  <stop offset="75%" stopColor="#c9d6cd" />
                  <stop offset="100%" stopColor="#6f8a7a" />
                </radialGradient>
                ...
                <filter id="wf" x="-20%" y="-20%" width="140%" height="140%">
                  <feDropShadow dx="0" dy="4" stdDeviation="7" floodColor="#0a1f16" floodOpacity="0.35" />
                </filter>
              </defs>
              {/* Wavy wax blob */}
              <path
              ...
              />
              {/* Inner rings */}
              <circle cx="90" cy="90" r="64" fill="none" stroke="#c9d6cd" strokeWidth="1.5" opacity="0.7" />
              <circle cx="90" cy="90" r="58" fill="none" stroke="#c9d6cd" strokeWidth="0.6" strokeDasharray="2 3.5" opacity="0.5" />
              {/* Engraved label */}
              <text x="90" y="86" fontFamily="'Cinzel', serif" fontSize="21" fontWeight="600" letterSpacing="2" fill="#5f7568" textAnchor="middle" opacity="0.92">TAP</text>
              <text x="90" y="108" fontFamily="'Cinzel', serif" fontSize="15" letterSpacing="1.5" fill="#5f7568" textAnchor="middle" opacity="0.85">TO OPEN</text>
              <path d="M74 96 q16 8 32 0" stroke="#5f7568" strokeWidth="1" fill="none" opacity="0.6" />
            </svg>
          </button>

          <svg className="env-flourish" viewBox="0 0 140 24" aria-hidden="true">
            <path d="M2 12h44M94 12h44" stroke="var(--silver)" strokeWidth="1" />
            <path d="M46 12c6-10 14-10 20 0 6 10 14 10 20 0" stroke="var(--silver)" strokeWidth="1" fill="none" />
          </svg>
      ...
      <section id="hero">
        ...
        >
          ...
          <svg className="ic-frame" viewBox="0 0 100 150" preserveAspectRatio="none" aria-hidden="true">
            <defs>
              <linearGradient id="ic-silverline" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0" stopColor="#5f7568" />
                <stop offset=".5" stopColor="#e7efe9" />
                <stop offset="1" stopColor="#5f7568" />
              </linearGradient>
            </defs>
          ...
          <svg className="ic-lantern ic-lantern--left" viewBox="0 0 24 40" fill="none" aria-hidden="true">
            <line x1="12" y1="0" x2="12" y2="6" stroke="#5f7568" strokeWidth="1.4" />
            <path d="M6 6h12l-2 4H8z" fill="#9fb3a7" />
            <rect x="7" y="10" width="10" height="16" rx="2" fill="#e7efe9" stroke="#5f7568" strokeWidth="1" />
            <circle cx="12" cy="18" r="3" fill="#f3f8f4" />
            <path d="M8 26h8l-2 4h-4z" fill="#9fb3a7" />
          </svg>
          ...
          <svg className="ic-floral ic-floral--tl" viewBox="0 0 64 64" fill="none" aria-hidden="true">
            <path d="M4 4 C18 6 28 14 32 28" stroke="#9fb3a7" strokeWidth="1.2" opacity="0.7" />
            <circle cx="10" cy="10" r="5" fill="#c98d85" opacity="0.55" />
            <circle cx="18" cy="16" r="3.2" fill="#bccdc3" opacity="0.8" />
            <circle cx="26" cy="24" r="2.4" fill="#9fb3a7" opacity="0.6" />
          </svg>
          ...
          <div className="ic-content">
            ...
            <div className="ic-divider" style={{ '--d': '.34s' }}>
              <svg viewBox="0 0 24 24"><path d="M12 2c3 4 3 8 0 12-3-4-3-8 0-12z" fill="#9fb3a7" /></svg>
            </div>
